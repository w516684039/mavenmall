							...
							<div class="box-bd">
								<div class="clearfix xm-address-list" id="checkoutAddrList">
									...
									<div class="item use-new-addr"  id="J_useNewAddr" data-state="off">
										<span class="iconfont icon-add"><img src="${ctx}/static/front/img/add_cart.png" /></span>
										使用新地址
									</div>
								</div>
									...
									<div class="checkout-count clearfix">
										...
										<div class="checkout-price">
											<ul>
												...
												<li>
													订单总额：<span id=allPrice>244元</span>
												</li>
												<li>
													活动优惠：<span>-0元</span>
													<script type="text/javascript">
			...
			<ul class="clearfix">
				...
				<li class="lss">
					...
					<div class="clearfix lss-pa">
						<div class="fl lss-img"><img  src="${ctx}/static/front/img/98.png" /></div>
