...
<header id="pc-header">
	<div class="pc-header-nav">
		<div class="pc-header-con">
			<div class="fl pc-header-link" >您好！，欢迎来靓淘网 <a href="login.html" target="_blank" id="user" value="${user.id}">${user.username}</a> <a href="register.html" target="_blank"> 免费注册</a></div>
	...
	<div class="member-center clearfix">
		<div class="member-left fl">
			<div class="member-apart clearfix">
				<div class="fl"><a href="#"><img src="${ctx}/static/front/img/wkz2.jpg"></a></div>
				<div class="fl">
					<p>用户名：</p>
										...
										<div class="ci1">
											<c:forEach items="${order.orderItems}" var="orderitem">
												<div class="ci7 clearfix">
													<span class="gr1"><a href="#"><img src="${imageServer}/${orderitem.productImage}" title="" about="" width="60" height="60"></a></span>
			...
			<ul class="clearfix">
				...
				<li class="lss">
					...
					<div class="clearfix lss-pa">
						<div class="fl lss-img"><img src="${ctx}/static/front/img/98.png" alt=""></div>
